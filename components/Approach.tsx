  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          title="Testing, Development & Launch"
          icon={<AceternityIcon order="Phase 3" />}
          des="Focus will shift to rigorous cross-browser testing, performance tuning, and accessibility checks to ensure smooth interactions, fast load times, and a seamless experience across devices."
        >
          <CanvasRevealEffect
            animationSpeed={3}
